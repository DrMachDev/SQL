# 🎓 Caso Academico – Proyecto de Base de Datos
...
*Tenemos viewa, funciones y triggers en el archivo [`view.sql`](https://github.com/DrMachDev/SQL/blob/main/caso_academico/caso_academico_vistas_funciones_trigger.sql), ubicado en la carpeta `scripts/` del repositorio.
